...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory('C:/Users/Aryan Verma/Desktop/fruit classifcation/dataset/train',
                                                target_size=(64,64),
                                                batch_size=12, #Total no. of batches
                                                class_mode='categorical')

test_set = test_datagen.flow_from_directory('C:/Users/Aryan Verma/Desktop/fruit classifcation/dataset/test',
                                            target_size=(64,64),
                                            batch_size=12,
                                            class_mode='categorical')

classifier.fit_generator(training_set,
                         steps_per_epoch=600, # Total training images
